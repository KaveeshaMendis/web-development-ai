...
<body>
    ...
    <div class="container-md text-center mt-5" style="max-width: 400px">
        ...
        <form>
            <div class="mb-3">
                <input type="email" class="form-control text-center fs-5 fw-light" id="exampleInputEmail1"
                    aria-describedby="emailHelp" placeholder="Email address" />
            </div>
            <div class="mb-3">
                <input type="password" class="form-control text-center fs-5 fw-light" id="password"
